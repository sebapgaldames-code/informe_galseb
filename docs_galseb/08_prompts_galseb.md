...
Interacciones con IA sobre el caso del cierre de servicios de TuMangaOnline(TMO)

| Sección | Prompt utilizado | Herramienta | Qué se aceptó | Que se corrigio |
| --- | --- | --- | --- | --- |
| Resumen | Genera un resumen de 3 parrafos sobre el documento PDF proporcionado | Copilot | Resumen coherente sobre la informacion dentro del informe | No hubo correccion |
| Marco normativo | Que consecuensias legales tendria la pagina de TMO dentro del marco normativo de las leyes informaticas actuales de Chile? | Copilot | Identificación de normas nacionales actuales relacionadas al posible delito | Se incluyó Ley 19.496 |
