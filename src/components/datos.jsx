...
export default function Datos() {
  return (
    <article className="doc-section">
      ...
      <h2 className="section-title">Protección de la vida privada</h2>
      ...
      <div className="subsection">
        ...
        <div className="datos-tags">
          {['Correos electrónicos', 'Direcciones IP', 'Historial de lectura', 'Cuentas de usuario', 'Contraseñas', 'Datos de navegación'].map((d) => (
