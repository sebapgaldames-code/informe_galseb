const delitos = [
  {
    art: 'Art. 2', nombre: 'Acceso ilícito',
  ...
  {
    art: 'Art. 3', nombre: 'Interceptación ilícita',
  ...
  {
    art: 'Art. 4', nombre: 'Ataque a la integridad de sistemas',
  ...
  {
    art: 'Art. 5', nombre: 'Ataque a la integridad de datos',
  ...
  {
    art: 'Art. 6', nombre: 'Receptación de datos informáticos',
...
export default function Delitos() {
  return (
    <article className="doc-section">
      <div className="section-badge">⚖️ Tipificación penal</div>
      <h2 className="section-title">
        <span className="title-emoji">🔨</span>
        Delitos según Ley 21.459
      </h2>
